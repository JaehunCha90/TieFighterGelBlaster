...
*                Defaults to true
*/
Servo(uint8_t address=0x40, double low_limit=1.0, double high_limit=2.0, bool reset=true);


/**
* Set the servo position
* @param channel - 1 to 16
* @param angle - value between -90 and 90.
*/

void angle(uint8_t channel, float angle);
